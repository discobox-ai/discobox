...
func (m *Model) helpText() string {
	return strings.Join([]string{
		...
		"",
		"  This is long: / searches it, Enter puts the line away and keeps the",
		"  matches, n and N walk them, and Esc closes.",
		"",
		...
		"      ⇡  ready      committed work that no apply has landed",
		"                    anywhere yet — ahead of every host, and what",
		"                    an apply from here would bring back",
		...
		"",
		"  Its services are tabs on the left, after the terminals — the",
		"  scripts this repository declares under .discobox/services,",
		...
		"",
		"  A service tab wears a • when it has printed something since you",
		"  last looked at it, which is the whole point of one running where",
		...
		"    " + m.leader() + " " + credentialsLeaderKey + "       answer the credential request the banner is",
		"                   about — " + credentialsLeaderKey + " for grant, since the leader's " + paneTerminalKey + " is",
		"                   another terminal and a shift away from it is no",
		"                   place for a key that hands out a credential",
