...
// answers to.
//
// The aliases are what a caller handing a host to another program needs — a
// host tool is given one as {ssh.host} (ADR 0125 §4) — and they cannot be
...
// and works out how this sandbox is reached in it. It is what a tool that runs
// on this machine is handed (ADR 0125 §4), and what the launcher's tools picker
// prints for copying:
