...
// attach's to make before it dials (deliverBeforeAttach, ADR 26-09-24-005), not a
// beat's.
...
// stopping is about the stop, and is dropped. An error from a transfer is never
