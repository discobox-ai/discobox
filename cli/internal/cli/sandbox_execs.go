...
type sandboxExecCreateOptions struct {
	...
	// from a shell (ADR 26-08-27-302 on tool sessions). There is no flag for it either:
...
type execAttachOptions struct {
	...
	// does (ADR 26-09-05-008 §1 on automatic push). It is the attach saying what it is
