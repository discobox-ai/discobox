...
func TestSandboxPositionalCompletionListsSandboxes(t *testing.T) {
	server := completionServer(t, map[string]string{
		"/projects/project-1/sandboxes": `{"sandboxes":[{"id":"sandbox-1","projectId":"project-1","createdByUserId":"user-1","config":{"name":"Alpha","image":""},"runtime":{"state":"running","desiredState":"present","generation":1,"observedGeneration":1},"createdAt":"2026-01-01T00:00:00Z","updatedAt":"2026-01-01T00:00:00Z"}]}`,
	})
	root := NewRootCommand()
