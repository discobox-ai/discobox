...
// repository-scoped counterpart to `sandbox list`, which lists every sandbox in
...
are not listed; use "discobox sandbox list" to list every sandbox in the project.`,
		Example: `  discobox ls
