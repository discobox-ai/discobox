...
- A **service is the second typed layer over `execs`**, and the rules that make
  ...
  (ADR 0068 §4), so there is no desired state to persist and no reconcile loop
