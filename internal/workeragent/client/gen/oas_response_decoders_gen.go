...
func decodeWorkerDeleteSandboxResponse(resp *http.Response) (res *WorkerDeleteSandboxNoContent, _ error) {
	switch resp.StatusCode {
	case 204:
		// Code 204.
		return &WorkerDeleteSandboxNoContent{}, nil
	}
	// Convenient error response.
	defRes, err := func() (res *ErrorModelStatusCode, err error) {
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
...
func decodeWorkerListSandboxesResponse(resp *http.Response) (res *WorkerSandboxListResponse, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
