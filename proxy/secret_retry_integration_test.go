...
// the way the first attempt was (ADR 26-09-22-838 §4). A grant revoked while the
...
// first attempt happened to resolve (ADR 26-09-22-838 §4). A sentinel whose resolve
