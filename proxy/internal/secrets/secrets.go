...
type Resolver interface {
	...
	// cached value never authorizes a new operation (ADR 26-09-22-838 §4). A resolver
...
// (ADR 26-09-22-838 §4). It walks exactly the surface Apply swaps, through the same
