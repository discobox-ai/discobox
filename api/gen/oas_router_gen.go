	...
	default:
		...
		case '/': // Prefix: "/"
			...
			case 'a': // Prefix: "api/p"
				...
				case 'o': // Prefix: "ools/"
					...
					case '/': // Prefix: "/"
						...
						switch elem[0] {
						case 'j': // Prefix: "judge-runtime"

							if l := len("judge-runtime"); len(elem) >= l && elem[0:l] == "judge-runtime" {
								elem = elem[l:]
							} else {
								break
							}
							...
							if len(elem) == 0 {
								...
								switch r.Method {
								case "GET":
									s.handleGetPoolJudgeRuntimeRequest([1]string{
										args[0],
									}, elemIsEscaped, w, r)
								default:
									s.notAllowed(w, r, notAllowedParams{
			...
			case 's': // Prefix: "ssh"
				...
				if l := len("ssh"); len(elem) >= l && elem[0:l] == "ssh" {
					elem = elem[l:]
				} else {
					break
				}
					...
					case '/': // Prefix: "/"
						...
						case 'j': // Prefix: "judge-runtime"
							...
							if len(elem) == 0 {
								...
								switch method {
								case "GET":
									r.name = GetPoolJudgeRuntimeOperation
									r.summary = "Get pool judge runtime."
									r.operationID = "get-pool-judge-runtime"
									r.operationGroup = ""
									r.pathPattern = "/api/pools/{poolId}/judge-runtime"
									r.args = args
									r.count = 1
									return r, true
								default:
										...
										case 'v': // Prefix: "verdicts"
											...
											if len(elem) == 0 {
												...
												case "POST":
													...
													r.summary = "Record a credential command or request verdict"
