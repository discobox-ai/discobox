...
type ApproveTrustRequestBody = apigen.ApproveTrustRequestBody
...
type CreatePeerBody = apigen.CreatePeerBody
...
type CreateSandboxTrustRequestBody = apigen.CreateSandboxTrustRequestBody
...
type CredentialVerdict = apigen.CredentialVerdict
type DNSAuditQuery = apigen.DNSAuditQuery
...
type HostTrust = apigen.HostTrust
type HostTrustRequest = apigen.HostTrustRequest
...
type ListHTTPAuditBody = apigen.ListHTTPAuditBody
...
type ListHostTrustsBody = apigen.ListHostTrustsBody
type ListJobsBody = apigen.ListJobsBody
type ListPeersBody = apigen.ListPeersBody
...
type ListSecretRefreshEventsBody = apigen.ListSecretRefreshEventsBody
type ListSecretRejectionsBody = apigen.ListSecretRejectionsBody
type ListSecretRequestsBody = apigen.ListSecretRequestsBody
type ListSecretsBody = apigen.ListSecretsBody
type ListTrustRequestsBody = apigen.ListTrustRequestsBody
...
type ObservedCertificate = apigen.ObservedCertificate
...
type ReportSandboxSecretRejectionBody = apigen.ReportSandboxSecretRejectionBody
...
type SandboxAgentMeta = apigen.SandboxAgentMeta
...
type SandboxExecInputBody = apigen.SandboxExecInputBody
type SandboxExecInputPart = apigen.SandboxExecInputPart
type SandboxExecInputResult = apigen.SandboxExecInputResult
type SandboxExecLogEntry = apigen.SandboxExecLogEntry
type SandboxExecLogsResponse = apigen.SandboxExecLogsResponse
type SandboxExecScreen = apigen.SandboxExecScreen
type SandboxExecWaitBody = apigen.SandboxExecWaitBody
type SandboxExecWaitResult = apigen.SandboxExecWaitResult
...
type SandboxToolsResponse = apigen.SandboxToolsResponse
type SandboxTrustRequestStatus = apigen.SandboxTrustRequestStatus
...
type SecretRefreshAnswer = apigen.SecretRefreshAnswer
type SecretRefreshEvent = apigen.SecretRefreshEvent
type SecretRejection = apigen.SecretRejection
type SecretRequest = apigen.SecretRequest
type SecretUse = apigen.SecretUse
type SecretValue = apigen.SecretValue
type ServerInfo = apigen.ServerInfo
...
type TrustPin = apigen.TrustPin
type UnavailableAuditPool = apigen.UnavailableAuditPool
...
type UpdateSandboxMetaBody = apigen.UpdateSandboxMetaBody
