...
type Handler interface {
	...
	JudgeSandbox(ctx context.Context, req *JudgeJob, params JudgeSandboxParams) (*JudgeAnswer, error)
	...
	SendSandboxExecInput(ctx context.Context, req *SandboxExecInputBody, params SendSandboxExecInputParams) (*SandboxExecInputResult, error)
	...
	UpdateSandboxAgentMeta(ctx context.Context, req *UpdateSandboxMetaBody, params UpdateSandboxAgentMetaParams) (*SandboxAgentMeta, error)
	...
	WaitSandboxExec(ctx context.Context, req *SandboxExecWaitBody, params WaitSandboxExecParams) (*SandboxExecWaitResult, error)
