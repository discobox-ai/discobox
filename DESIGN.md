...
| [`releasemanifest`](releasemanifest/DESIGN.md) | Full release artifact inventory: named runtime image roles, harness images, and optional platform server downloads. Also consumed by development builds through `DISCOBOX_RELEASE_MANIFEST`. |
