...
- **Status**: Accepted
- **Partially superseded by**: [0032](0032-every-sandbox-has-a-harness-config-and-shell-is-the-built-in.md) — its treatment of sandboxes with no harness config only; the rest stands.
- **Date**: 2026-07-23
