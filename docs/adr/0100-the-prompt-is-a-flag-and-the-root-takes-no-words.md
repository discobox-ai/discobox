...
- **§§3–4's command spelling superseded by**: [0128](0128-the-command-that-makes-a-discobox-is-new.md) — the command that keeps a trailing prompt is `discobox new`, with `run` kept as an alias, and §4's preview fallback names `new` too. What §3 and §4 decide stands.
- **Date**: 2026-09-07
