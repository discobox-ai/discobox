...
- **§6's key loaded only for a bound endpoint superseded by**: [0114](0114-every-server-has-a-peer-id.md) — every server loads its key on every start; the endpoint itself stays opt-in.
- **Date**: 2026-08-19
