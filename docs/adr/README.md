...
| [0105](0105-a-release-is-cut-as-a-prerelease-and-blessed-stable-later.md) | A release is cut as a prerelease and blessed stable by hand | Accepted (§2 amended by [0109](0109-the-install-script-is-a-release-asset-and-a-channel-names-which-one-runs.md) — an explicit prerelease reaches the opt-in `edge` channel) |
| [0106](0106-a-consumer-points-at-the-asset-mirror-only-if-it-can-fall-back.md) | A consumer points at the asset mirror only if it can fall back | Accepted (amends [0099](0099-the-cli-downloads-the-server-it-starts.md) §3 — an asset names an ordered list of URLs; §4 superseded by [0109](0109-the-install-script-is-a-release-asset-and-a-channel-names-which-one-runs.md) for the installer's two addresses) |
