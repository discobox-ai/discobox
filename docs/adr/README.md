...
| [0113](0113-the-cli-stages-the-images-its-server-loads.md) | A release CLI stages its server's images, and a pool loads them before it pulls | Proposed (amends [0099](0099-the-cli-downloads-the-server-it-starts.md) §3 — a manifest lists its server's images) |
