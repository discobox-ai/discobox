...
| [0013](0013-local-linux-pools-use-libkrun-microvms.md) | Local Linux pools use libkrun microVMs with VSOCK and passt | Accepted (§1's launcher lifetime and §2's host-side artifact build superseded by [0062](0062-macos-pools-run-vz-vms-with-an-independently-released-guest-image.md) §9; §2's runtime closure by [0148](0148-a-linux-release-defaults-to-libkrun-and-ships-what-it-needs.md)) |
...
| [0078](0078-the-wsl-proxycommand-is-quoted-for-sh.md) | The WSL bridge, corrected: quoting, the key's ACL, and both sides written | Accepted (amends [0074](0074-a-wsl-cli-writes-the-ssh-config-windows-reads.md) §2, §3; §2's ACL superseded by [0101](0101-a-mirrored-key-carries-the-acl-ssh-reads.md)) |
...
| [0101](0101-one-guest-image-for-every-vm-backend-and-the-kernel-is-separate.md) | One guest image for every VM backend, and the kernel is a separate artifact | Accepted (settles [0062](0062-macos-pools-run-vz-vms-with-an-independently-released-guest-image.md)'s deferred one-image question; §3 superseded by [0148](0148-a-linux-release-defaults-to-libkrun-and-ships-what-it-needs.md)) |
...
| [0113](0113-the-cli-stages-the-images-its-server-loads.md) | A release CLI stages its server's images, and a pool loads them before it pulls | Accepted (deferred libkrun staging superseded by [0148](0148-a-linux-release-defaults-to-libkrun-and-ships-what-it-needs.md)) |
...
| [0146](0143-an-arrival-no-later-than-the-build-is-an-unknown-age.md) | An image arrival no later than its build is an unknown age | Accepted (supersedes [0040](0040-discobox-images-are-reclaimed-by-label-and-local-age.md) §2's build premise) |
| [0147](0144-a-pool-of-host-vm-sandboxes-runs-its-agent-on-the-host.md) | A pool of host-VM sandboxes runs its agent on the host | Accepted (narrows [0006](0006-pool-is-the-runtime-host.md)'s Docker-host pool for that pool kind) |
...
| [0148](0148-a-linux-release-defaults-to-libkrun-and-ships-what-it-needs.md) | A Linux release defaults to libkrun, and the image it boots carries what it needs | Accepted (supersedes [0101](0101-one-guest-image-for-every-vm-backend-and-the-kernel-is-separate.md) §3 and [0113](0113-the-cli-stages-the-images-its-server-loads.md)'s deferred libkrun staging) |
