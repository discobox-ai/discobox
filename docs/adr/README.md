...
| [0150](0150-attaching-to-a-discobox-awaiting-its-source-delivers-it.md) | Attaching to a discobox still awaiting its source delivers it | Accepted (supersedes [0095](0095-an-attached-client-pushes-the-commits-made-where-it-runs.md) §2's parked-discobox rule) |
