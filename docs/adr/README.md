...
| [0075](0075-the-nix-store-is-a-pool-shared-cache-seeded-on-first-use.md) | The nix store is a pool-shared cache, seeded from the image on first use | Accepted (§5's stamps superseded by [0082](0082-the-nix-seed-stamp-names-the-store-that-seeded-it.md)) |
