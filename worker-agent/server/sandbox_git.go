...
import (
	...
	"github.com/obot-platform/discobox/worker-agent/githttp"
...
func registerSandboxGitRoutes(router chi.Router, service *sandboxService) {
	router.Handle("/api/project/{projectId}/worker/{workerId}/sandboxes/{sandboxId}/git-repositories/*", service.sandboxGitHTTPHandler())
}
