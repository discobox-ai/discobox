...
func encodeWorkerDeleteSandboxResponse(response *WorkerDeleteSandboxNoContent, w http.ResponseWriter, span trace.Span) error {
	w.WriteHeader(204)
...
func encodeWorkerListSandboxesResponse(response *WorkerSandboxListResponse, w http.ResponseWriter, span trace.Span) error {
	w.Header().Set("Content-Type", "application/json; charset=utf-8")
	w.WriteHeader(200)
	span.SetStatus(codes.Ok, http.StatusText(200))
