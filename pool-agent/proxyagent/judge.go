...
// Asking the project's judge (ADR 0141 §4).
//
...
//
// The body is described and not carried (ADR 0141 §6). What can be said about
...
// `X-Functions-Key`). ADR 0141 §6 asks for the headers worth weighing, and
