...
// Encode implements json.Marshaler.
func (s *HarnessSecret) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *HarnessSecret) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("name")
		e.Str(s.Name)
	}
...
var jsonFieldsNameOfHarnessSecret = [4]string{
	0: "name",
	1: "required",
	2: "oneOfGroup",
	3: "delivery",
...
// Decode decodes HarnessSecret from json.
func (s *HarnessSecret) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode HarnessSecret to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode HarnessSecret")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfHarnessSecret) {
					name = jsonFieldsNameOfHarnessSecret[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *HarnessSecret) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *HarnessSecret) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
// Encode encodes []HarnessSecret as json.
func (o OptNilHarnessSecretArray) Encode(e *jx.Encoder) {
	if !o.Set {
		return
	}
	if o.Null {
...
// Decode decodes []HarnessSecret from json.
func (o *OptNilHarnessSecretArray) Decode(d *jx.Decoder) error {
	if o == nil {
		return errors.New("invalid: unable to decode OptNilHarnessSecretArray to nil")
	}
	if d.Next() == jx.Null {
		if err := d.Null(); err != nil {
			return err
	...
	o.Set = true
	o.Null = false
	o.Value = make([]HarnessSecret, 0)
	if err := d.Arr(func(d *jx.Decoder) error {
		var elem HarnessSecret
		if err := elem.Decode(d); err != nil {
			return err
		}
		o.Value = append(o.Value, elem)
...
// MarshalJSON implements stdjson.Marshaler.
func (s OptNilHarnessSecretArray) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *OptNilHarnessSecretArray) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
// Encode implements json.Marshaler.
func (s *PoolClearCacheResponse) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *PoolClearCacheResponse) encodeFields(e *jx.Encoder) {
	{
		if s.Schema.Set {
			e.FieldStart("$schema")
			s.Schema.Encode(e)
...
var jsonFieldsNameOfPoolClearCacheResponse = [2]string{
	0: "$schema",
	1: "stoppedSandboxIds",
}

// Decode decodes PoolClearCacheResponse from json.
func (s *PoolClearCacheResponse) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode PoolClearCacheResponse to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode PoolClearCacheResponse")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfPoolClearCacheResponse) {
					name = jsonFieldsNameOfPoolClearCacheResponse[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *PoolClearCacheResponse) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *PoolClearCacheResponse) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode implements json.Marshaler.
func (s *PoolDNSAuditQuery) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *PoolDNSAuditQuery) encodeFields(e *jx.Encoder) {
	{
		if s.Schema.Set {
			e.FieldStart("$schema")
			s.Schema.Encode(e)
...
var jsonFieldsNameOfPoolDNSAuditQuery = [10]string{
	0: "$schema",
	1: "answers",
	2: "createdAt",
	3: "durationMillis",
...
// Decode decodes PoolDNSAuditQuery from json.
func (s *PoolDNSAuditQuery) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode PoolDNSAuditQuery to nil")
	}
	var requiredBitSet [2]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode PoolDNSAuditQuery")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [2]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfPoolDNSAuditQuery) {
					name = jsonFieldsNameOfPoolDNSAuditQuery[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *PoolDNSAuditQuery) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *PoolDNSAuditQuery) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode implements json.Marshaler.
func (s *PoolDNSAuditResponse) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *PoolDNSAuditResponse) encodeFields(e *jx.Encoder) {
	{
		if s.Schema.Set {
			e.FieldStart("$schema")
			s.Schema.Encode(e)
...
var jsonFieldsNameOfPoolDNSAuditResponse = [2]string{
	0: "$schema",
	1: "queries",
}

// Decode decodes PoolDNSAuditResponse from json.
func (s *PoolDNSAuditResponse) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode PoolDNSAuditResponse to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "queries":
			requiredBitSet[0] |= 1 << 1
			if err := func() error {
				s.Queries = make([]PoolDNSAuditQuery, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem PoolDNSAuditQuery
					if err := elem.Decode(d); err != nil {
						return err
					}
		...
		return errors.Wrap(err, "decode PoolDNSAuditResponse")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfPoolDNSAuditResponse) {
					name = jsonFieldsNameOfPoolDNSAuditResponse[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *PoolDNSAuditResponse) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *PoolDNSAuditResponse) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode implements json.Marshaler.
func (s *PoolHTTPAuditExchange) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *PoolHTTPAuditExchange) encodeFields(e *jx.Encoder) {
	{
		if s.Schema.Set {
			e.FieldStart("$schema")
			s.Schema.Encode(e)
...
func (s *PoolHTTPAuditExchange) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode PoolHTTPAuditExchange to nil")
	}
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode PoolHTTPAuditExchange")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [3]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfPoolHTTPAuditExchange) {
					name = jsonFieldsNameOfPoolHTTPAuditExchange[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *PoolHTTPAuditExchange) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *PoolHTTPAuditExchange) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode implements json.Marshaler.
func (s *PoolHTTPAuditExchangeDetail) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *PoolHTTPAuditExchangeDetail) encodeFields(e *jx.Encoder) {
	{
		if s.Schema.Set {
			e.FieldStart("$schema")
			s.Schema.Encode(e)
...
var jsonFieldsNameOfPoolHTTPAuditExchangeDetail = [40]string{
	...
	16: "requestBodyBytes",
	17: "requestBodyError",
	18: "requestBodyFormat",
	19: "requestBodyRecorded",
	20: "requestHeaders",
	21: "responseBodyError",
	22: "responseBodyFormat",
	23: "responseBodyRecorded",
	24: "responseBytes",
	25: "responseHeaders",
	26: "sandboxId",
	27: "status",
	28: "streamDroppedBytes",
	29: "streamDroppedChunks",
	30: "streamFormat",
	31: "streamRecorded",
	32: "streamSessionId",
	33: "swappedUseIds",
...
func (s *PoolHTTPAuditExchangeDetail) Decode(d *jx.Decoder) error {
	if s == nil {
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode PoolHTTPAuditExchangeDetail")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [5]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfPoolHTTPAuditExchangeDetail) {
					name = jsonFieldsNameOfPoolHTTPAuditExchangeDetail[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *PoolHTTPAuditExchangeDetail) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *PoolHTTPAuditExchangeDetail) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode implements json.Marshaler.
func (s PoolHTTPAuditExchangeDetailRequestHeaders) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
func (s PoolHTTPAuditExchangeDetailRequestHeaders) encodeFields(e *jx.Encoder) {
	for k, elem := range s {
		e.FieldStart(k)
...
// Decode decodes PoolHTTPAuditExchangeDetailRequestHeaders from json.
func (s *PoolHTTPAuditExchangeDetailRequestHeaders) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode PoolHTTPAuditExchangeDetailRequestHeaders to nil")
	}
	m := s.init()
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		var elem []string
		...
		return errors.Wrap(err, "decode PoolHTTPAuditExchangeDetailRequestHeaders")
	}
...
// MarshalJSON implements stdjson.Marshaler.
func (s PoolHTTPAuditExchangeDetailRequestHeaders) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *PoolHTTPAuditExchangeDetailRequestHeaders) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode implements json.Marshaler.
func (s PoolHTTPAuditExchangeDetailResponseHeaders) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields implements json.Marshaler.
func (s PoolHTTPAuditExchangeDetailResponseHeaders) encodeFields(e *jx.Encoder) {
	for k, elem := range s {
		e.FieldStart(k)
...
// Decode decodes PoolHTTPAuditExchangeDetailResponseHeaders from json.
func (s *PoolHTTPAuditExchangeDetailResponseHeaders) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode PoolHTTPAuditExchangeDetailResponseHeaders to nil")
	}
	m := s.init()
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		var elem []string
		...
		return errors.Wrap(err, "decode PoolHTTPAuditExchangeDetailResponseHeaders")
	}
...
// MarshalJSON implements stdjson.Marshaler.
func (s PoolHTTPAuditExchangeDetailResponseHeaders) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *PoolHTTPAuditExchangeDetailResponseHeaders) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode implements json.Marshaler.
func (s *PoolHTTPAuditResponse) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *PoolHTTPAuditResponse) encodeFields(e *jx.Encoder) {
	{
		if s.Schema.Set {
			e.FieldStart("$schema")
			s.Schema.Encode(e)
...
var jsonFieldsNameOfPoolHTTPAuditResponse = [2]string{
	0: "$schema",
	1: "exchanges",
}

// Decode decodes PoolHTTPAuditResponse from json.
func (s *PoolHTTPAuditResponse) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode PoolHTTPAuditResponse to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "exchanges":
			requiredBitSet[0] |= 1 << 1
			if err := func() error {
				s.Exchanges = make([]PoolHTTPAuditExchange, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem PoolHTTPAuditExchange
					if err := elem.Decode(d); err != nil {
						return err
					}
		...
		return errors.Wrap(err, "decode PoolHTTPAuditResponse")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfPoolHTTPAuditResponse) {
					name = jsonFieldsNameOfPoolHTTPAuditResponse[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *PoolHTTPAuditResponse) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *PoolHTTPAuditResponse) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode implements json.Marshaler.
func (s *PoolSandboxCreateRequest) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *PoolSandboxCreateRequest) encodeFields(e *jx.Encoder) {
	{
		if s.Schema.Set {
			e.FieldStart("$schema")
			s.Schema.Encode(e)
...
func (s *PoolSandboxCreateRequest) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode PoolSandboxCreateRequest to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode PoolSandboxCreateRequest")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfPoolSandboxCreateRequest) {
					name = jsonFieldsNameOfPoolSandboxCreateRequest[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *PoolSandboxCreateRequest) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// Encode implements json.Marshaler.
func (s *PoolSandboxInstance) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *PoolSandboxInstance) encodeFields(e *jx.Encoder) {
	{
		if s.Schema.Set {
			e.FieldStart("$schema")
			s.Schema.Encode(e)
...
var jsonFieldsNameOfPoolSandboxInstance = [5]string{
	0: "$schema",
	1: "config",
	2: "resolvedHarnessConfig",
	3: "runtime",
...
// Decode decodes PoolSandboxInstance from json.
func (s *PoolSandboxInstance) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode PoolSandboxInstance to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode PoolSandboxInstance")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfPoolSandboxInstance) {
					name = jsonFieldsNameOfPoolSandboxInstance[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *PoolSandboxInstance) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *PoolSandboxInstance) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode implements json.Marshaler.
func (s *PoolSandboxListResponse) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *PoolSandboxListResponse) encodeFields(e *jx.Encoder) {
	{
		if s.Schema.Set {
			e.FieldStart("$schema")
			s.Schema.Encode(e)
...
var jsonFieldsNameOfPoolSandboxListResponse = [2]string{
	0: "$schema",
	1: "sandboxes",
}

// Decode decodes PoolSandboxListResponse from json.
func (s *PoolSandboxListResponse) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode PoolSandboxListResponse to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "sandboxes":
			...
			if err := func() error {
				...
				default:
					s.Sandboxes = make([]PoolSandboxInstance, 0)
					if err := d.Arr(func(d *jx.Decoder) error {
						var elem PoolSandboxInstance
						if err := elem.Decode(d); err != nil {
							return err
						}
		...
		return errors.Wrap(err, "decode PoolSandboxListResponse")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfPoolSandboxListResponse) {
					name = jsonFieldsNameOfPoolSandboxListResponse[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *PoolSandboxListResponse) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *PoolSandboxListResponse) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
// encodeFields encodes fields.
func (s *PoolSandboxOperationRequest) encodeFields(e *jx.Encoder) {
	{
		if s.Schema.Set {
			e.FieldStart("$schema")
			s.Schema.Encode(e)
...
var jsonFieldsNameOfPoolSandboxOperationRequest = [2]string{
	0: "$schema",
	1: "force",
}

// Decode decodes PoolSandboxOperationRequest from json.
func (s *PoolSandboxOperationRequest) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode PoolSandboxOperationRequest to nil")
	}
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode PoolSandboxOperationRequest")
	}
...
// MarshalJSON implements stdjson.Marshaler.
func (s *PoolSandboxOperationRequest) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *PoolSandboxOperationRequest) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode implements json.Marshaler.
func (s *PoolSandboxPort) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *PoolSandboxPort) encodeFields(e *jx.Encoder) {
	{
...
var jsonFieldsNameOfPoolSandboxPort = [4]string{
	0: "containerPort",
	1: "hostIp",
	2: "hostPort",
	3: "protocol",
...
// Decode decodes PoolSandboxPort from json.
func (s *PoolSandboxPort) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode PoolSandboxPort to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode PoolSandboxPort")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfPoolSandboxPort) {
					name = jsonFieldsNameOfPoolSandboxPort[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *PoolSandboxPort) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *PoolSandboxPort) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode implements json.Marshaler.
func (s *PoolSandboxRuntime) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *PoolSandboxRuntime) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("createdAt")
		json.EncodeDateTime(e, s.CreatedAt)
	}
...
var jsonFieldsNameOfPoolSandboxRuntime = [10]string{
	0: "createdAt",
	1: "env",
	2: "error",
	3: "image",
...
// Decode decodes PoolSandboxRuntime from json.
func (s *PoolSandboxRuntime) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode PoolSandboxRuntime to nil")
	}
	var requiredBitSet [2]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "ports":
			...
			if err := func() error {
				...
				default:
					s.Ports = make([]PoolSandboxPort, 0)
					if err := d.Arr(func(d *jx.Decoder) error {
						var elem PoolSandboxPort
						if err := elem.Decode(d); err != nil {
							return err
						}
		...
		return errors.Wrap(err, "decode PoolSandboxRuntime")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [2]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfPoolSandboxRuntime) {
					name = jsonFieldsNameOfPoolSandboxRuntime[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *PoolSandboxRuntime) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *PoolSandboxRuntime) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode implements json.Marshaler.
func (s PoolSandboxRuntimeEnv) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields implements json.Marshaler.
func (s PoolSandboxRuntimeEnv) encodeFields(e *jx.Encoder) {
	for k, elem := range s {
		e.FieldStart(k)
...
// Decode decodes PoolSandboxRuntimeEnv from json.
func (s *PoolSandboxRuntimeEnv) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode PoolSandboxRuntimeEnv to nil")
	}
	m := s.init()
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		var elem string
		...
		return errors.Wrap(err, "decode PoolSandboxRuntimeEnv")
	}
...
// MarshalJSON implements stdjson.Marshaler.
func (s PoolSandboxRuntimeEnv) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *PoolSandboxRuntimeEnv) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode implements json.Marshaler.
func (s PoolSandboxRuntimeMetadata) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields implements json.Marshaler.
func (s PoolSandboxRuntimeMetadata) encodeFields(e *jx.Encoder) {
	for k, elem := range s {
		e.FieldStart(k)
...
// Decode decodes PoolSandboxRuntimeMetadata from json.
func (s *PoolSandboxRuntimeMetadata) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode PoolSandboxRuntimeMetadata to nil")
	}
	m := s.init()
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		var elem string
		...
		return errors.Wrap(err, "decode PoolSandboxRuntimeMetadata")
	}
...
// MarshalJSON implements stdjson.Marshaler.
func (s PoolSandboxRuntimeMetadata) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *PoolSandboxRuntimeMetadata) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode implements json.Marshaler.
func (s *PoolSandboxUpdateRequest) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *PoolSandboxUpdateRequest) encodeFields(e *jx.Encoder) {
	{
		if s.Schema.Set {
			e.FieldStart("$schema")
			s.Schema.Encode(e)
...
func (s *PoolSandboxUpdateRequest) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode PoolSandboxUpdateRequest to nil")
	}
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode PoolSandboxUpdateRequest")
	}
...
// MarshalJSON implements stdjson.Marshaler.
func (s *PoolSandboxUpdateRequest) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// Encode implements json.Marshaler.
func (s *PoolSyncRequest) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *PoolSyncRequest) encodeFields(e *jx.Encoder) {
	{
		if s.Schema.Set {
			e.FieldStart("$schema")
			s.Schema.Encode(e)
	...
	{
		e.FieldStart("knownPoolIds")
		e.ArrStart()
		for _, elem := range s.KnownPoolIds {
			e.Str(elem)
		}
		e.ArrEnd()
	}
...
var jsonFieldsNameOfPoolSyncRequest = [2]string{
	0: "$schema",
	1: "knownPoolIds",
}

// Decode decodes PoolSyncRequest from json.
func (s *PoolSyncRequest) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode PoolSyncRequest to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "knownPoolIds":
			...
			if err := func() error {
				...
				if err := d.Arr(func(d *jx.Decoder) error {
					...
					s.KnownPoolIds = append(s.KnownPoolIds, elem)
					return nil
				}); err != nil {
					return err
				}
				...
				return errors.Wrap(err, "decode field \"knownPoolIds\"")
			}
		default:
			return errors.Errorf("unexpected field %q", k)
		}
		...
		return errors.Wrap(err, "decode PoolSyncRequest")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfPoolSyncRequest) {
					name = jsonFieldsNameOfPoolSyncRequest[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *PoolSyncRequest) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *PoolSyncRequest) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
...
var jsonFieldsNameOfResolvedHarnessConfig = [12]string{
	0:  "files",
	1:  "configuredFiles",
	2:  "id",
	3:  "name",
...
var jsonFieldsNameOfSandboxUpdateConfig = [3]string{
	0: "env",
	1: "image",
	2: "workingDirectory",
}
