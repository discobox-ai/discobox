...
func (s *PoolDNSAuditQuery) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s *PoolDNSAuditResponse) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s *PoolHTTPAuditExchange) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s *PoolHTTPAuditResponse) Validate() error {
	if s == nil {
		return validate.ErrNilPointer
	}
...
func (s PoolListDNSAuditOrder) Validate() error {
	switch s {
	case "asc":
		return nil
	case "desc":
