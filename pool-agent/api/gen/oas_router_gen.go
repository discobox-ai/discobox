		...
		case '/': // Prefix: "/"
			...
			case 'j': // Prefix: "judge"
				...
				if len(elem) == 0 {
					...
					switch r.Method {
					case "POST":
						s.handlePoolJudgeRequest([0]string{}, elemIsEscaped, w, r)
					default:
						s.notAllowed(w, r, notAllowedParams{
							allowedMethods: "POST",
		...
		case '/': // Prefix: "/"
			...
			case 'j': // Prefix: "judge"
				...
				if len(elem) == 0 {
					...
					switch method {
					case "POST":
						r.name = PoolJudgeOperation
						r.summary = "Judge a typed credential operation over pool-private IPC."
						r.operationID = "pool-judge"
						r.operationGroup = ""
						r.pathPattern = "/judge"
						r.args = args
						r.count = 0
