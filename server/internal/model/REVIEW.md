...
- Use hard deletes only for documented exceptions such as `HarnessConfig`, append-only/audit rows, short-lived operational state, or rows whose deletion is the state transition.
