...
var yamlOwnedEnums = map[string]string{
	...
	"JudgeJob.kind":                      "what a judge is asked about, owned by the root judge package and never stored (ADR 26-09-22-838)",
	"JudgeNeed.body":                     "how a judge may ask to be shown a body, owned by the root judge package (ADR 26-09-22-838 §6)",
	"JudgeRequestBody.form":              "how a body is written when a judge is shown one, owned by the root judge package (ADR 26-09-22-838 §6)",
