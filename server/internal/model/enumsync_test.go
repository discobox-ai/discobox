...
var yamlOwnedEnums = map[string]string{
	...
	"SandboxService.status":              "service state is derived by the sandbox-agent from the exec running a repository-declared service (ADR 0068); the server stores nothing about services",
