...
type Project struct {
	...
	// JudgePoolID is the pool the project's judge runs in (ADR 26-09-22-838 §1). It is
...
type Sandbox struct {
	...
	// (ADR 26-09-24-630 §1). The sandbox role delivers source only into a sandbox the
